...
Main3:Button("by ui and all 2x hub",function()
...
Main3:Toggle("AutoFarm Level",_G.AutoFarm,function(value)
    ...
    Main:Seperator("à¸—à¸µà¹ˆà¹ƒà¸ªà¹ˆà¸­à¸²à¸§à¸¸à¸˜à¸ªà¸³à¸«à¸£à¸±à¸šà¸—à¸³à¸‚à¸­à¸‡")
        WeaponList = {}
...
spawn(function()
    ...
    Settings:Toggle("SuperVeryFast Attack(à¸¡à¸µà¹‚à¸­à¸à¸²à¸ªà¹‚à¸”à¸™à¹€à¸•à¸°)",nil,function(value)
